...
Examples:
    python3 -m timingnet.search --circuit-type digital --top-k 3
    python3 -m timingnet.search --circuit-type analog --top-k 5 --num-circuits 30
...
def main(argv=None) -> int:
    ...
    if ckpt is None:
        print(f"No checkpoint available for --circuit-type {args.circuit_type}. "
              "Train one first, e.g.:\n"
              "  python3 -m timingnet.train --num-circuits 200 --epochs 10")
