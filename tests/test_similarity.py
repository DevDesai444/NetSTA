...
def circuit_index(tmp_chroma_dir, untrained_model, small_dataset):
    ...
    from netsta.similarity.circuit_index import CircuitIndex
    idx = CircuitIndex(
...
def test_find_similar_self_returns_self_first(
    ...
    from netsta.similarity.search import find_similar
...
def test_compare_identical_circuits_is_one(untrained_model, small_dataset):
    from netsta.similarity.search import compare_circuits
...
def test_find_by_property_metadata_filter(circuit_index):
    ...
    from netsta.similarity.search import find_by_property
...
def test_index_schema_tag_consistent(circuit_index):
    from netsta.similarity.circuit_index import INDEX_SCHEMA_TAG
